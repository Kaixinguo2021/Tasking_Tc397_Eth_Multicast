...
IFX_INLINE void IfxGeth_mac_setAllMulticastPassing(Ifx_GETH *gethSFR, boolean enabled)
{
    ...
    /* Add by Song 20231121,When this bit is set, the MAC Receiver module passes all received packets 
       to the application, irrespective of whether they pass the address filter or not.*/
    gethSFR->MAC_PACKET_FILTER.B.RA   = 1;
}
